...
// The METRIC is automation success (did the run complete?), not the theme verdict.
const automationOk = v !== null && pw !== null;
const subject = `[Theme QA] ${automationOk ? 'تقرير جاهز' : 'لم تكتمل الأتمتة'} — ${themeId}`;
...
await t.sendMail({
  ...
  text: `تقرير اختبار الثيم ${themeId}. الأتمتة: ${automationOk ? 'اكتملت' : 'لم تكتمل'}. التقرير مرفق.`,
  html,
