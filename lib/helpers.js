...
const CONSOLE_IGNORE = [
  ...
  // Platform/third-party SDK identity + auth noise (not a theme defect):
  /dmdsdk|useridentities|either email or mobile/i,
  /Failed to load resource.*status of (400|401|403)/i,
];
